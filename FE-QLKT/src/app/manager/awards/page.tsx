          ...
          <div style={{ maxWidth: 400 }}>
            {thanhTichList.map((tt, index) => (
              <div key={tt.id} style={{ marginBottom: index < thanhTichList.length - 1 ? 12 : 0 }}>
                <div>
                  <Tag color={tt.loai === "NCKH" ? "blue" : "green"}>
                    {tt.loai}
                  </Tag>
                  {tt.status === "APPROVED" ? (
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "24px" }}>
        <div>
          <Title level={2} style={{ margin: 0 }}>Khen Thưởng Đơn Vị</Title>
      ...
      >
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "16px" }}>
          <div>
            <Text strong style={{ display: "block", marginBottom: "8px" }}>Năm</Text>
            <Input
              type="number"
          ...
          <div>
            <Text strong style={{ display: "block", marginBottom: "8px" }}>Danh hiệu</Text>
            <Input
      ...
      {/* Awards Table */}
      <Card
        title={`Danh sách khen thưởng (${awards.length})`}
      >
