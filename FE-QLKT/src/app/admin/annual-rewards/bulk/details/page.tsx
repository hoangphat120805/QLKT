...
export default function BulkRewardDetailsPage() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.log('🔍 [Details Page] Parsed:', {
        personnelIds,
        eligibleIds,
        personnelIdsCount: personnelIds.length,
        eligibleIdsCount: eligibleIds.length,
      });
      ...
      console.log('🔍 [Details Page] Initial data:', initialData);
  ...
  const handleSubmit = async () => {
    try {
      ...
      console.log('🔍 [handleSubmit] Submitting:', {
        personnelIds,
        personnelRewardsData,
        eligibleCount: eligiblePersonnel.length,
