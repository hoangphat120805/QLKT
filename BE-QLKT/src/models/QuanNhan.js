...
const QuanNhan = sequelize.define(
  'QuanNhan',
  {
    ...
    co_quan_don_vi: {
      ...
      allowNull: true,
      comment: 'JSON lưu thông tin cơ quan đơn vị: {don_vi_cap_tren, co_quan_don_vi, tap_the}',
    },
    ngay_nhap_ngu: {
      type: DataTypes.DATEONLY,
      allowNull: true,
    ...
    ngay_xuat_ngu: {
      type: DataTypes.DATEONLY,
      allowNull: true,
      comment: 'Phục vụ cho tính thời gian để nhận Kỷ niệm chương (20 năm nữ, 25 năm nam)',
    },
    ngay_vao_dang: {
      type: DataTypes.DATEONLY,
      allowNull: true,
